 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://fmt.com/", wsdlLocation = "http://172.16.16.102:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://fmt.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.16.16.102:8080/hello?wsdl");
    ...
    public com.fmt.HelloService getHelloServicePort() {
        return super.getPort(new QName("http://fmt.com/", "HelloServicePort"), com.fmt.HelloService.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloServicePort")
    public com.fmt.HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://fmt.com/", "HelloServicePort"), com.fmt.HelloService.class, features);
    }
